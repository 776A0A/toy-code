...
export class Timeline {
  ...
  add(animation, addTime) {
    ...
    if (this.state === PLAYING) this.addTimes.set(animation, addTime ?? Date.now() - this.startTime)
